...
class ErrorMessages:
    ...
    INSUFFICIENT_SPACE = "Insufficient disk space: {required} GB required, {available} GB available"
...
class SuccessMessages:
    ...
    DATASET_PREPARED = "Dataset prepared successfully: {train_size} train, {test_size} test samples"
    TRAINING_COMPLETE = "Training completed successfully in {duration:.2f} seconds"
    INFERENCE_COMPLETE = "Inference completed on {num_images} images in {duration:.2f} seconds"
