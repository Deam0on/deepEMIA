...
def start_fastapi():
    ...
    print("   - Network:  http://0.0.0.0:8888")
    print("   - External: http://[VM_EXTERNAL_IP]:8888")
    print("📚 API Documentation:")
    print("   - Swagger:  http://[VM_EXTERNAL_IP]:8888/api/docs")
    print("   - ReDoc:    http://[VM_EXTERNAL_IP]:8888/api/redoc")
    print("=" * 60)
