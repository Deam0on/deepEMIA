...
```
- Access via VM external IP: `http://[VM_EXTERNAL_IP]:8505`
- API Documentation: `http://[VM_EXTERNAL_IP]:8505/api/docs`
...
The FastAPI server is configured to listen on `0.0.0.0:8505`, making it accessible from:
- **Local**: `http://localhost:8505`
- **Network**: `http://[INTERNAL_IP]:8505`
- **External**: `http://[VM_EXTERNAL_IP]:8505`

Make sure your VM firewall allows incoming connections on port 8505.
